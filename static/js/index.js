...
/*!*************************************!*\
  !*** ./src/javascript/analytics.js ***!
  \*************************************/
/*! exports provided: NULL_VALUE, gaAll, gaTest, dimensions, metrics, init, trackError, trackNoGoogleAnalyticsAccounts */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NULL_VALUE", function() { return NULL_VALUE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "gaAll", function() { return gaAll; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "gaTest", function() { return gaTest; });
...
/* harmony import */ var autotrack_lib_plugins_clean_url_tracker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! autotrack/lib/plugins/clean-url-tracker */ "./node_modules/autotrack/lib/plugins/clean-url-tracker.js");
/* harmony import */ var autotrack_lib_plugins_event_tracker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! autotrack/lib/plugins/event-tracker */ "./node_modules/autotrack/lib/plugins/event-tracker.js");
/* harmony import */ var autotrack_lib_plugins_impression_tracker__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! autotrack/lib/plugins/impression-tracker */ "./node_modules/autotrack/lib/plugins/impression-tracker.js");
/* harmony import */ var autotrack_lib_plugins_max_scroll_tracker__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! autotrack/lib/plugins/max-scroll-tracker */ "./node_modules/autotrack/lib/plugins/max-scroll-tracker.js");
/* harmony import */ var autotrack_lib_plugins_media_query_tracker__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! autotrack/lib/plugins/media-query-tracker */ "./node_modules/autotrack/lib/plugins/media-query-tracker.js");
/* harmony import */ var autotrack_lib_plugins_outbound_link_tracker__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! autotrack/lib/plugins/outbound-link-tracker */ "./node_modules/autotrack/lib/plugins/outbound-link-tracker.js");
/* harmony import */ var autotrack_lib_plugins_page_visibility_tracker__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! autotrack/lib/plugins/page-visibility-tracker */ "./node_modules/autotrack/lib/plugins/page-visibility-tracker.js");
/* harmony import */ var tti_polyfill_src__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! tti-polyfill/src */ "./node_modules/tti-polyfill/src/index.js");
/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! uuid */ "./node_modules/uuid/uuid.js");
...
var ALL_TRACKERS = [{
  name: 'prod',
  trackingId: 'UA-41425441-5'
}, {
  name: 'test',
  trackingId: 'UA-41425441-7'
}];
/**
    ...
    try {
      var _loop = function _loop() {
        ...
        if (typeof command === 'function') {
          window.ga(function () {
            return command(window.ga.getByName(name));
          });
        } else {
          var _window;

          (_window = window).ga.apply(_window, ["".concat(name, ".").concat(command)].concat(args));
        }
      };
...
var trackError = function trackError() {
  ...
  gaAll('send', 'event', Object.assign({
    ...
    eventLabel: "".concat(err.message, "\n").concat(err.stack || '(no stack trace)'),
    nonInteraction: true
  }, fieldsObj));
};
/**
...
var createTrackers = function createTrackers() {
  for (var _i = 0, _ALL_TRACKERS = ALL_TRACKERS; _i < _ALL_TRACKERS.length; _i++) {
    var tracker = _ALL_TRACKERS[_i];
  ...
  gaAll('set', 'transport', 'beacon'); // Log hits in non-production environments.
...
var trackErrors = function trackErrors() {
  ...
  var trackErrorEvent = function trackErrorEvent(event) {
    ...
    var err = event.error || {
      message: "".concat(event.message, " (").concat(event.lineno, ":").concat(event.colno, ")")
    };
  ...
  try {
    for (var _iterator2 = loadErrorEvents[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
var trackCustomDimensions = function trackCustomDimensions() {
  ...
  gaAll(function (tracker) {
    ...
    tracker.set((_tracker$set = {}, _defineProperty(_tracker$set, dimensions.TRACKING_VERSION, TRACKING_VERSION), _defineProperty(_tracker$set, dimensions.CLIENT_ID, tracker.get('clientId')), _defineProperty(_tracker$set, dimensions.WINDOW_ID, uuid__WEBPACK_IMPORTED_MODULE_8___default()()), _tracker$set));
  ...
  gaAll(function (tracker) {
    ...
    tracker.set('buildHitTask', function (model) {
      ...
      model.set(dimensions.HIT_ID, uuid__WEBPACK_IMPORTED_MODULE_8___default()(), true);
      model.set(dimensions.HIT_TYPE, hitType, true);
      model.set(dimensions.VISIBILITY_STATE, document.visibilityState, true);
      var qt = model.get('queueTime') || 0;
      model.set(dimensions.HIT_TIME, String(new Date() - qt), true); // TODO(philipwalton): temporary fix to address an analytics.js bug where
...
var stopPreloadAbandonTracking = function stopPreloadAbandonTracking() {
  window.removeEventListener('unload', window.__trackAbandons);
};

var trackTimeToFirstConsistentlyInteractive = function trackTimeToFirstConsistentlyInteractive() {
  var postLoadAbandonTracking = function postLoadAbandonTracking() {
  ...
  Object(tti_polyfill_src__WEBPACK_IMPORTED_MODULE_7__["getFirstConsistentlyInteractive"])().then(function (ttci) {
    if (ttci > 0) {
      gaTest('send', 'event', _defineProperty({
        eventCategory: 'PW Metrics',
        eventAction: 'track',
        eventLabel: NULL_VALUE,
        eventValue: 1,
        // Number of metrics track with event.
        nonInteraction: true
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _analytics__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./analytics */ "./src/javascript/analytics.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  addOpenHandler: function addOpenHandler() {
    var _this = this;

    $(document).on('touchend.header click.header', '#header-user', function (event) {
      event.preventDefault();

      _this.open();
    });
  },
  addCloseHandler: function addCloseHandler() {
    var _this2 = this;
  ...
  addSignOutHandler: function addSignOutHandler() {
    var _this3 = this;

    $('#header-sign-out').on('click', function (event) {
  ...
  open: function open() {
    ...
    Object(_analytics__WEBPACK_IMPORTED_MODULE_0__["gaAll"])('send', 'event', 'Header', 'open');
  },
  close: function close() {
    $(document).off('.header');
    this.addOpenHandler();
    $('#header').removeClass('is-open');
    Object(_analytics__WEBPACK_IMPORTED_MODULE_0__["gaAll"])('send', 'event', 'Header', 'close');
  }
});

/***/ }),

/***/ "./src/javascript/highlighter.js":
/*!***************************************!*\
  !*** ./src/javascript/highlighter.js ***!
  \***************************************/
/*! exports provided: highlightAll, highlight */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "highlightAll", function() { return highlightAll; });
...
highlight_js_lib_highlight__WEBPACK_IMPORTED_MODULE_0___default.a.registerLanguage('xml', __webpack_require__(/*! highlight.js/lib/languages/xml */ "./node_modules/highlight.js/lib/languages/xml.js"));
...
highlight_js_lib_highlight__WEBPACK_IMPORTED_MODULE_0___default.a.registerLanguage('python', __webpack_require__(/*! highlight.js/lib/languages/python */ "./node_modules/highlight.js/lib/languages/python.js"));
/**
...
function highlightAll(selector) {
  $(selector).each(function () {
    highlight_js_lib_highlight__WEBPACK_IMPORTED_MODULE_0___default.a.highlightBlock(this);
  });
}
/**
...
function highlight(_ref) {
  var lang = _ref.lang,
      code = _ref.code;
  return highlight_js_lib_highlight__WEBPACK_IMPORTED_MODULE_0___default.a.highlight(lang, code).value;
}
...
/* harmony import */ var _analytics__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./analytics */ "./src/javascript/analytics.js");
/* harmony import */ var _header__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./header */ "./src/javascript/header.js");
/* harmony import */ var _highlighter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./highlighter */ "./src/javascript/highlighter.js");
/* harmony import */ var _sidebar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./sidebar */ "./src/javascript/sidebar.js");
// Copyright 2016 Google Inc. All rights reserved.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
svg4everybody_dist_svg4everybody__WEBPACK_IMPORTED_MODULE_0___default()(); // Setup Google Analytics tracking.

_analytics__WEBPACK_IMPORTED_MODULE_1__["init"](); // Initiaze the header functionality.

_header__WEBPACK_IMPORTED_MODULE_2__["default"].init(); // Initiaze the sidebar functionality.

_sidebar__WEBPACK_IMPORTED_MODULE_4__["default"].init(); // Highlight code blocks.

_highlighter__WEBPACK_IMPORTED_MODULE_3__["highlightAll"]('pre');
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  addCloseHandler: function addCloseHandler() {
    $(document).on('touchend.sidebar click.sidebar', function (event) {
      var $target = $(event.target); // Close of the user clicked the close icon or clicked
  ...
  open: function open() {
    ...
    Object(_analytics__WEBPACK_IMPORTED_MODULE_0__["gaAll"])('send', 'event', 'Sidebar', 'open');
  },
  close: function close() {
    $(document.body).removeClass('is-expanded');
    Object(_analytics__WEBPACK_IMPORTED_MODULE_0__["gaAll"])('send', 'event', 'Sidebar', 'close');
  }
});
