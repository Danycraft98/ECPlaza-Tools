# Generated by Django 3.1.7 on 2021-05-14 07:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('infocenterfood', models.CharField(max_length=15, verbose_name='문의 전화번호')),
                ('chkcreditcardfood', models.CharField(max_length=15, verbose_name='체크/신용카드')),
                ('discountinfofood', models.CharField(max_length=15, verbose_name='할인 정보')),
                ('firstmenu', models.CharField(max_length=15, verbose_name='메인 음식')),
                ('treatmenu', models.CharField(max_length=15, verbose_name='사이드 음식')),
                ('kidsfacility', models.BooleanField(default=False, verbose_name='아동시설')),
                ('parkingfood', models.CharField(max_length=15, verbose_name='주차 가능')),
                ('opentimefood', models.CharField(max_length=50, verbose_name='운영 시간')),
                ('restdatefood', models.CharField(max_length=50, verbose_name='휴일 정보')),
            ],
            bases=('tools.tourinfo',),
        ),
        migrations.CreateModel(
